        ...
        <body>
          <a id="button"></a>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="MainPage.php">יציאה</a></li>
            </ul>
            </div>
        </div>
        </nav>
              ...
              <div class="col-sm-12">
                  ...
                  <div class="tab-content col-sm-9">
                    <div class="tab-pane active" id="home">
                        <hr>
                          <form class="form" action="thirdPageLogin.php" method="post" id="registrationForm">                   
                              ...
                              <!--              enter the stauts after login, for teachers   
                              <div class="form-group">
                                  <div class="col-sm-6">
                                     <label for="mobile"><h4 class="inputWords">סטטוס</h4></label>
                                      <input type="text" class="inputWordsInside form-control" name="status" id="status"  placeholder="טטוס">
                                  </div>
                              </div>-->
                              <div class="form-group">
                            ...
                            <!--  <form method="POST" action="thirdPageLogin.php" enctype="multipart/form-data">
          --> <div class="form-group">
                                <div class="col-sm-12">
                             ...
                             <br />
                              ...
                              <div class="form-group">
                                   <div class="col-xs-12">
                                        <br>
                                          <label for="Savee"></label>
                                          <input id="saveButton" type="submit" name="Savee" value="שמור">
                                    </div>
                              </div>          
          </form>-->
                             <div class="form-group">
